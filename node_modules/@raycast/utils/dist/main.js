...
const $31a0ba4a4e2328d9$var$isX = !!process.env.RAYCASTX;
function $31a0ba4a4e2328d9$export$378f247c814d3cc9(name, options) {
    ...
    const svgInitials = initials ? `<text x="50" y="${$31a0ba4a4e2328d9$var$isX ? 50 : 80}" font-size="${radius - 1}" font-family="Inter, sans-serif" text-anchor="middle" ${$31a0ba4a4e2328d9$var$isX ? 'dominant-baseline="central" ' : ""}fill="white">${initials.toUpperCase()}</text>` : "";
...
function $7cabae6fedcce1d1$var$getProtocol() {
    return (0, $8zHUo$raycastapi.environment).raycastVersion.includes("alpha") ? process.env.RAYCASTX ? "raycast-x-internal://" : "raycastinternal://" : "raycast://";
}

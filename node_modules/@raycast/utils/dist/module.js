import $hgUW1$react, {useRef as $hgUW1$useRef, useState as $hgUW1$useState, useCallback as $hgUW1$useCallback, useEffect as $hgUW1$useEffect, useMemo as $hgUW1$useMemo, useSyncExternalStore as $hgUW1$useSyncExternalStore} from "react";
...
import $hgUW1$nodefs, {readFileSync as $hgUW1$readFileSync, createWriteStream as $hgUW1$createWriteStream, createReadStream as $hgUW1$createReadStream, mkdirSync as $hgUW1$mkdirSync, existsSync as $hgUW1$existsSync} from "node:fs";
import $hgUW1$nodepath, {join as $hgUW1$join, normalize as $hgUW1$normalize} from "node:path";
import $hgUW1$nodecrypto from "node:crypto";
import $hgUW1$nodechild_process from "node:child_process";
import {constants as $hgUW1$constants} from "node:buffer";
import $hgUW1$nodestream, {Duplex as $hgUW1$Duplex, Readable as $hgUW1$Readable, Writable as $hgUW1$Writable} from "node:stream";
...
import {StringDecoder as $hgUW1$StringDecoder} from "node:string_decoder";
import $hgUW1$nodeevents from "node:events";
...
function $cefc05764ce5eacd$export$dd6b79aaabe7bc37(fn, args, options) {
    ...
    const latestCallback = (0, $hgUW1$useRef)(null);
    ...
    const abort = (0, $hgUW1$useCallback)(()=>{
...
/* eslint-disable @typescript-eslint/ban-ts-comment */ /* eslint-disable @typescript-eslint/no-this-alias */ /* eslint-disable @typescript-eslint/no-explicit-any */ /** Check if the given function is a native function */ function $93381684554307cb$var$isNativeFunction(f) {
...
function $e2e1ea6dd3b7d2e1$export$d6af199866bfb566(object) {
    const hashingStream = (0, $hgUW1$nodecrypto).createHash("sha1");
...
function $a7f3824c7be647eb$export$b15740c74e256244(fn, args, options) {
   ...
   */ const { initialData: initialData, keepPreviousData: keepPreviousData, internal_cacheKeySuffix: internal_cacheKeySuffix, ...usePromiseOptions } = options || {};
    const lastUpdateFrom = (0, $hgUW1$useRef)(null);
...
function $07de1abb43355e7b$export$d852f5f778460fa4(url, options) {
    ...
    const urlRef = (0, $hgUW1$useRef)(null);
    const firstPageUrlRef = (0, $hgUW1$useRef)(null);
   ...
   */ if (!urlRef.current || typeof firstPageUrlRef.current === "undefined" || firstPageUrlRef.current !== firstPageUrl) urlRef.current = url;
    ...
    const abortable = (0, $hgUW1$useRef)(null);
    ...
    return (0, $a7f3824c7be647eb$export$b15740c74e256244)(promise, [
        ...
        internal_cacheKeySuffix: firstPageUrlRef.current + (0, $e2e1ea6dd3b7d2e1$export$d6af199866bfb566)(mapResultRef.current) + (0, $e2e1ea6dd3b7d2e1$export$d6af199866bfb566)(parseResponseRef.current),
        abortable: abortable
    });
}
...
class $e6272883088c6834$var$Emitter {
    constructor(){
        ...
        this.id = Math.random();
        // @ts-ignore
        if ($parcel$global[$e6272883088c6834$var$kExitEmitter]) // @ts-ignore
...
class $e6272883088c6834$var$SignalExitFallback {
    onExit() {
        return ()=>{};
    }
    load() {}
...
class $e6272883088c6834$var$SignalExit {
    ...
    onExit(cb, opts) {
        /* c8 ignore start */ if (!$e6272883088c6834$var$processOk(this.#process)) return ()=>{};
    ...
    #processReallyExit(code) {
        /* c8 ignore start */ if (!$e6272883088c6834$var$processOk(this.#process)) return 0;
...
let $e6272883088c6834$var$signalExit = null;
const $e6272883088c6834$export$47a57ed64c292d4f = (cb, opts)=>{
...
const $da9d03b67f2b5a2f$export$f883a24d5edde77c = /* #__PURE__ */ Symbol.for("object-stream.none");
const $da9d03b67f2b5a2f$var$stop = /* #__PURE__ */ Symbol.for("object-stream.stop");
const $da9d03b67f2b5a2f$var$finalSymbol = /* #__PURE__ */ Symbol.for("object-stream.final");
const $da9d03b67f2b5a2f$var$manySymbol = /* #__PURE__ */ Symbol.for("object-stream.many");
const $da9d03b67f2b5a2f$var$flushSymbol = /* #__PURE__ */ Symbol.for("object-stream.flush");
const $da9d03b67f2b5a2f$var$fListSymbol = /* #__PURE__ */ Symbol.for("object-stream.fList");
const $da9d03b67f2b5a2f$var$finalValue = (value)=>({
        [$da9d03b67f2b5a2f$var$finalSymbol]: 1,
        value: value
    });
const $da9d03b67f2b5a2f$export$14badfee79ea396f = (values)=>({
        [$da9d03b67f2b5a2f$var$manySymbol]: 1,
        values: values
    });
const $da9d03b67f2b5a2f$var$isFinalValue = (o)=>o && o[$da9d03b67f2b5a2f$var$finalSymbol] === 1;
const $da9d03b67f2b5a2f$var$isMany = (o)=>o && o[$da9d03b67f2b5a2f$var$manySymbol] === 1;
const $da9d03b67f2b5a2f$var$isFlushable = (o)=>o && o[$da9d03b67f2b5a2f$var$flushSymbol] === 1;
const $da9d03b67f2b5a2f$var$isFunctionList = (o)=>o && o[$da9d03b67f2b5a2f$var$fListSymbol] === 1;
const $da9d03b67f2b5a2f$var$getFinalValue = (o)=>o.value;
const $da9d03b67f2b5a2f$var$getManyValues = (o)=>o.values;
const $da9d03b67f2b5a2f$var$getFunctionList = (o)=>o.fList;
const $da9d03b67f2b5a2f$export$586a8898e7177441 = (a, b)=>{
    const values = a === $da9d03b67f2b5a2f$export$f883a24d5edde77c ? [] : a?.[$da9d03b67f2b5a2f$var$manySymbol] === 1 ? a.values : [
        a
    ];
    if (b === $da9d03b67f2b5a2f$export$f883a24d5edde77c) ;
    else if (b?.[$da9d03b67f2b5a2f$var$manySymbol] === 1) values.push(...b.values);
    else values.push(b);
    return $da9d03b67f2b5a2f$export$14badfee79ea396f(values);
};
const $da9d03b67f2b5a2f$export$fdd9dbe8c8ef20af = (write, final = null)=>{
    const fn = final ? (value)=>value === $da9d03b67f2b5a2f$export$f883a24d5edde77c ? $da9d03b67f2b5a2f$var$finalValue(undefined) : write(value) : write;
    // @ts-ignore
    fn[$da9d03b67f2b5a2f$var$flushSymbol] = 1;
    return fn;
};
const $da9d03b67f2b5a2f$var$setFunctionList = (o, fns)=>{
    o.fList = fns;
    o[$da9d03b67f2b5a2f$var$fListSymbol] = 1;
    return o;
};
// is*NodeStream functions taken from https://github.com/nodejs/node/blob/master/lib/internal/streams/utils.js
const $da9d03b67f2b5a2f$var$isReadableNodeStream = (obj)=>obj && typeof obj.pipe === "function" && typeof obj.on === "function" && (!obj._writableState || (typeof obj._readableState === "object" ? obj._readableState.readable : null) !== false) && // Duplex
    (!obj._writableState || obj._readableState); // Writable has .pipe.
const $da9d03b67f2b5a2f$var$isWritableNodeStream = (obj)=>obj && typeof obj.write === "function" && typeof obj.on === "function" && (!obj._readableState || (typeof obj._writableState === "object" ? obj._writableState.writable : null) !== false); // Duplex
const $da9d03b67f2b5a2f$var$isDuplexNodeStream = (obj)=>obj && typeof obj.pipe === "function" && obj._readableState && typeof obj.on === "function" && typeof obj.write === "function";
const $da9d03b67f2b5a2f$var$isReadableWebStream = (obj)=>obj && globalThis.ReadableStream && obj instanceof globalThis.ReadableStream;
const $da9d03b67f2b5a2f$var$isWritableWebStream = (obj)=>obj && globalThis.WritableStream && obj instanceof globalThis.WritableStream;
const $da9d03b67f2b5a2f$var$isDuplexWebStream = (obj)=>obj && globalThis.ReadableStream && obj.readable instanceof globalThis.ReadableStream && globalThis.WritableStream && obj.writable instanceof globalThis.WritableStream;
const $da9d03b67f2b5a2f$var$groupFunctions = (output, fn, index, fns)=>{
    if ($da9d03b67f2b5a2f$var$isDuplexNodeStream(fn) || !index && $da9d03b67f2b5a2f$var$isReadableNodeStream(fn) || index === fns.length - 1 && $da9d03b67f2b5a2f$var$isWritableNodeStream(fn)) {
        output.push(fn);
        return output;
    }
    if ($da9d03b67f2b5a2f$var$isDuplexWebStream(fn)) {
        output.push((0, $hgUW1$Duplex).fromWeb(fn, {
            objectMode: true
        }));
        return output;
    }
    if (!index && $da9d03b67f2b5a2f$var$isReadableWebStream(fn)) {
        output.push((0, $hgUW1$Readable).fromWeb(fn, {
            objectMode: true
        }));
        return output;
    }
    if (index === fns.length - 1 && $da9d03b67f2b5a2f$var$isWritableWebStream(fn)) {
        output.push((0, $hgUW1$Writable).fromWeb(fn, {
            objectMode: true
        }));
        return output;
    }
...
class $da9d03b67f2b5a2f$var$Stop extends Error {
}
const $da9d03b67f2b5a2f$export$bfe5aec46c67bf9d = (fn)=>{
    ...
    const sanitize = async (value)=>{
        if (value === undefined || value === null || value === $da9d03b67f2b5a2f$export$f883a24d5edde77c) return;
        if (value === $da9d03b67f2b5a2f$var$stop) throw new $da9d03b67f2b5a2f$var$Stop();
        if ($da9d03b67f2b5a2f$var$isMany(value)) {
            pushResults($da9d03b67f2b5a2f$var$getManyValues(value));
            return pump();
        }
        if ($da9d03b67f2b5a2f$var$isFinalValue(value)) {
            // a final value is not supported, it is treated as a regular value
            value = $da9d03b67f2b5a2f$var$getFinalValue(value);
    ...
    const processChunk = async (chunk, encoding)=>{
        try {
            ...
            if (error instanceof $da9d03b67f2b5a2f$var$Stop) {
                stream.push(null);
                stream.destroy();
                return;
            }
    ...
    stream = new (0, $hgUW1$Duplex)(Object.assign({
        ...
        final (callback) {
            if (!$da9d03b67f2b5a2f$var$isFlushable(fn)) {
                stream.push(null);
                callback(null);
                return;
            }
            processChunk($da9d03b67f2b5a2f$export$f883a24d5edde77c, null).then(()=>(stream.push(null), callback(null)), (error)=>callback(error));
        },
        read () {
            resume();
        }
...
const $da9d03b67f2b5a2f$var$produceStreams = (item)=>{
    if (Array.isArray(item)) {
        if (!item.length) return null;
        if (item.length == 1) return item[0] && $da9d03b67f2b5a2f$export$bfe5aec46c67bf9d(item[0]);
        return $da9d03b67f2b5a2f$export$bfe5aec46c67bf9d($da9d03b67f2b5a2f$export$ca954a7249f984a5(...item));
    }
    return item;
};
const $da9d03b67f2b5a2f$var$next = async function*(value, fns, index) {
    for(let i = index; i <= fns.length; ++i){
        if (value && typeof value.then == "function") // thenable
        value = await value;
        if (value === $da9d03b67f2b5a2f$export$f883a24d5edde77c) break;
        if (value === $da9d03b67f2b5a2f$var$stop) throw new $da9d03b67f2b5a2f$var$Stop();
        if ($da9d03b67f2b5a2f$var$isFinalValue(value)) {
            yield $da9d03b67f2b5a2f$var$getFinalValue(value);
            break;
        }
        if ($da9d03b67f2b5a2f$var$isMany(value)) {
            const values = $da9d03b67f2b5a2f$var$getManyValues(value);
            if (i == fns.length) yield* values;
            else for(let j = 0; j < values.length; ++j)yield* $da9d03b67f2b5a2f$var$next(values[j], fns, i);
            break;
        }
        if (value && typeof value.next == "function") {
            // generator
            for(;;){
                ...
                else yield* $da9d03b67f2b5a2f$var$next(data.value, fns, i);
            }
            break;
        }
        if (i == fns.length) {
...
const $da9d03b67f2b5a2f$export$ca954a7249f984a5 = (...fns)=>{
    fns = fns.filter((fn)=>fn).flat(Infinity).map((fn)=>$da9d03b67f2b5a2f$var$isFunctionList(fn) ? $da9d03b67f2b5a2f$var$getFunctionList(fn) : fn).flat(Infinity);
    if (!fns.length) fns = [
        (x)=>x
    ];
    let flushed = false;
    let g = async function*(value) {
        ...
        if (value !== $da9d03b67f2b5a2f$export$f883a24d5edde77c) yield* $da9d03b67f2b5a2f$var$next(value, fns, 0);
        else {
            flushed = true;
            for(let i = 0; i < fns.length; ++i){
                const f = fns[i];
                if ($da9d03b67f2b5a2f$var$isFlushable(f)) yield* $da9d03b67f2b5a2f$var$next(f($da9d03b67f2b5a2f$export$f883a24d5edde77c), fns, i + 1);
            }
        }
    };
    const needToFlush = fns.some((fn)=>$da9d03b67f2b5a2f$var$isFlushable(fn));
    if (needToFlush) g = $da9d03b67f2b5a2f$export$fdd9dbe8c8ef20af(g);
    return $da9d03b67f2b5a2f$var$setFunctionList(g, fns);
};
const $da9d03b67f2b5a2f$var$write = (input, chunk, encoding, callback)=>{
    let error = null;
    try {
...
const $da9d03b67f2b5a2f$var$final = (input, callback)=>{
    let error = null;
    try {
...
const $da9d03b67f2b5a2f$var$read = (output)=>{
    output.resume();
};
function $da9d03b67f2b5a2f$export$2e2bcd8739ae039(fns) {
    fns = fns.flat(Infinity).filter((fn)=>fn);
    const streams = fns.map((fn)=>$da9d03b67f2b5a2f$var$isFunctionList(fn) ? $da9d03b67f2b5a2f$var$getFunctionList(fn) : fn).flat(Infinity).reduce($da9d03b67f2b5a2f$var$groupFunctions, []).map($da9d03b67f2b5a2f$var$produceStreams).filter((s)=>s), input = streams[0], output = streams.reduce((output, item)=>output && output.pipe(item) || item);
    // eslint-disable-next-line prefer-const
    let stream; // will be assigned later
    let writeMethod = (chunk, encoding, callback)=>$da9d03b67f2b5a2f$var$write(input, chunk, encoding, callback), finalMethod = (callback)=>$da9d03b67f2b5a2f$var$final(input, callback), readMethod = ()=>$da9d03b67f2b5a2f$var$read(output);
    if (!$da9d03b67f2b5a2f$var$isWritableNodeStream(input)) {
        writeMethod = (_1, _2, callback)=>callback(null);
        finalMethod = (callback)=>callback(null);
        input.on("end", ()=>stream.end());
    }
    if ($da9d03b67f2b5a2f$var$isReadableNodeStream(output)) {
    ...
    stream = new (0, $hgUW1$Duplex)(Object.assign({
        ...
        readable: $da9d03b67f2b5a2f$var$isReadableNodeStream(output),
        writable: $da9d03b67f2b5a2f$var$isWritableNodeStream(input),
        write: writeMethod,
        final: finalMethod,
        read: readMethod
    }));
    ...
    if (!$da9d03b67f2b5a2f$var$isReadableNodeStream(output)) stream.resume();
    // connect events
...
const $42dd20cbfadceb69$var$fixUtf8Stream = ()=>{
    const stringDecoder = new (0, $hgUW1$StringDecoder)();
    let input = "";
    return (0, $da9d03b67f2b5a2f$export$fdd9dbe8c8ef20af)((chunk)=>{
        if (chunk === (0, $da9d03b67f2b5a2f$export$f883a24d5edde77c)) {
...
const $42dd20cbfadceb69$var$patterns = {
...
const $42dd20cbfadceb69$var$MAX_PATTERN_SIZE = 16;
const $42dd20cbfadceb69$var$values = {
    true: true,
    false: false,
    null: null
}, $42dd20cbfadceb69$var$expected = {
    object: "objectStop",
    array: "arrayStop",
    "": "done"
};
// long hexadecimal codes: \uXXXX
const $42dd20cbfadceb69$var$fromHex = (s)=>String.fromCharCode(parseInt(s.slice(2), 16));
// short codes: \b \f \n \r \t \" \\ \/
const $42dd20cbfadceb69$var$codes = {
    b: "\b",
    f: "\f",
    n: "\n",
    r: "\r",
...
const $42dd20cbfadceb69$var$jsonParser = (options)=>{
    ...
    const stack = [];
    return (0, $da9d03b67f2b5a2f$export$fdd9dbe8c8ef20af)((buf)=>{
        const tokens = [];
        if (buf === (0, $da9d03b67f2b5a2f$export$f883a24d5edde77c)) done = true;
        else buffer += buf;
        let match;
        let value;
        let index = 0;
        main: for(;;)switch(expect){
            case "value1":
            case "value":
                $42dd20cbfadceb69$var$patterns.value1.lastIndex = index;
                match = $42dd20cbfadceb69$var$patterns.value1.exec(buffer);
                if (!match) {
                    if (done || index + $42dd20cbfadceb69$var$MAX_PATTERN_SIZE < buffer.length) {
                ...
                switch(value){
                    ...
                    case "]":
                        ...
                        parent = stack.pop();
                        expect = $42dd20cbfadceb69$var$expected[parent];
                        break;
                    case "-":
                        openNumber = true;
                        if (streamNumbers) tokens.push({
                    ...
                    case "null":
                        ...
                        tokens.push({
                            name: value + "Value",
                            value: $42dd20cbfadceb69$var$values[value]
                        });
                        expect = $42dd20cbfadceb69$var$expected[parent];
                        break;
                }
            ...
            case "keyVal":
            case "string":
                $42dd20cbfadceb69$var$patterns.string.lastIndex = index;
                match = $42dd20cbfadceb69$var$patterns.string.exec(buffer);
                if (!match) {
                ...
                if (value === '"') {
                    ...
                    const t = value.length == 2 ? $42dd20cbfadceb69$var$codes[value.charAt(1)] : $42dd20cbfadceb69$var$fromHex(value);
            ...
            case "key1":
            case "key":
                $42dd20cbfadceb69$var$patterns.key1.lastIndex = index;
                match = $42dd20cbfadceb69$var$patterns.key1.exec(buffer);
                if (!match) {
                ...
                break;
            case "colon":
                $42dd20cbfadceb69$var$patterns.colon.lastIndex = index;
                match = $42dd20cbfadceb69$var$patterns.colon.exec(buffer);
                if (!match) {
            ...
            case "arrayStop":
            case "objectStop":
                $42dd20cbfadceb69$var$patterns.comma.lastIndex = index;
                match = $42dd20cbfadceb69$var$patterns.comma.exec(buffer);
                if (!match) {
                    if (index < buffer.length || done) throw new Error("Parser cannot parse input: expected ','");
                    break main; // wait for more input
                }
            ...
            // number chunks
            case "numberStart":
                $42dd20cbfadceb69$var$patterns.numberStart.lastIndex = index;
                match = $42dd20cbfadceb69$var$patterns.numberStart.exec(buffer);
                if (!match) {
                ...
                break;
            case "numberDigit":
                $42dd20cbfadceb69$var$patterns.numberDigit.lastIndex = index;
                match = $42dd20cbfadceb69$var$patterns.numberDigit.exec(buffer);
                if (!match) {
                ...
                break;
            case "numberFraction":
                $42dd20cbfadceb69$var$patterns.numberFraction.lastIndex = index;
                match = $42dd20cbfadceb69$var$patterns.numberFraction.exec(buffer);
                if (!match) {
            ...
            case "numberFracDigit":
                ...
                break;
            case "numberExponent":
                $42dd20cbfadceb69$var$patterns.numberExponent.lastIndex = index;
                match = $42dd20cbfadceb69$var$patterns.numberExponent.exec(buffer);
                if (!match) {
                    if (index < buffer.length) {
                        expect = $42dd20cbfadceb69$var$expected[parent];
                        break;
                ...
                break;
            case "numberExpSign":
                $42dd20cbfadceb69$var$patterns.numberExpSign.lastIndex = index;
                match = $42dd20cbfadceb69$var$patterns.numberExpSign.exec(buffer);
                if (!match) {
                    if (index < buffer.length) {
            ...
            case "numberExpDigit":
                ...
                break;
            case "done":
                $42dd20cbfadceb69$var$patterns.ws.lastIndex = index;
                match = $42dd20cbfadceb69$var$patterns.ws.exec(buffer);
                if (!match) {
                    if (index < buffer.length) {
                        if (jsonStreaming) {
                            expect = "value";
        ...
        return tokens.length ? (0, $da9d03b67f2b5a2f$export$14badfee79ea396f)(tokens) : (0, $da9d03b67f2b5a2f$export$f883a24d5edde77c);
    });
};
const $42dd20cbfadceb69$export$8f49e4af10703ce3 = (options)=>(0, $da9d03b67f2b5a2f$export$ca954a7249f984a5)($42dd20cbfadceb69$var$fixUtf8Stream(), $42dd20cbfadceb69$var$jsonParser(options));
const $42dd20cbfadceb69$var$withParser = (fn, options)=>(0, $da9d03b67f2b5a2f$export$ca954a7249f984a5)($42dd20cbfadceb69$export$8f49e4af10703ce3(options), fn(options));
const $42dd20cbfadceb69$var$checkableTokens = {
    startObject: 1,
    startArray: 1,
    startString: 1,
    startNumber: 1,
    ...
    stringValue: 1,
    numberValue: 1
}, $42dd20cbfadceb69$var$stopTokens = {
    startObject: "endObject",
    startArray: "endArray",
    startString: "endString",
    startNumber: "endNumber"
}, $42dd20cbfadceb69$var$optionalTokens = {
    endString: "stringValue",
    endNumber: "numberValue"
};
const $42dd20cbfadceb69$var$defaultFilter = (_stack, _a)=>true;
const $42dd20cbfadceb69$var$stringFilter = (string, separator)=>{
...
const $42dd20cbfadceb69$var$regExpFilter = (regExp, separator)=>{
    return (stack, _a)=>regExp.test(stack.join(separator));
};
const $42dd20cbfadceb69$var$filterBase = ({ specialAction: specialAction = "accept", defaultAction: defaultAction = "ignore", nonCheckableAction: nonCheckableAction = "process-key", transition: transition } = {})=>(options)=>{
        const once = options?.once, separator = options?.pathSeparator || ".";
        let filter = $42dd20cbfadceb69$var$defaultFilter, streamKeys = true;
        if (options) {
            if (typeof options.filter == "function") filter = options.filter;
            else if (typeof options.filter == "string") filter = $42dd20cbfadceb69$var$stringFilter(options.filter, separator);
            else if (options.filter instanceof RegExp) filter = $42dd20cbfadceb69$var$regExpFilter(options.filter, separator);
        ...
        return (0, $da9d03b67f2b5a2f$export$fdd9dbe8c8ef20af)((chunk)=>{
            // the flush
            if (chunk === (0, $da9d03b67f2b5a2f$export$f883a24d5edde77c)) return transition ? transition([], null, "flush", sanitizedOptions) : (0, $da9d03b67f2b5a2f$export$f883a24d5edde77c);
            // process the optional value token (unfinished)
            if (optionalToken) {
                if (optionalToken === chunk.name) {
                    let returnToken = (0, $da9d03b67f2b5a2f$export$f883a24d5edde77c);
                    switch(state){
                        case "process-key":
            ...
            recheck: for(;;){
                ...
                switch(state){
                    case "process-key":
                        ...
                        return 0, $da9d03b67f2b5a2f$export$f883a24d5edde77c;
                    case "pass":
                        return 0, $da9d03b67f2b5a2f$export$f883a24d5edde77c;
                    case "all":
                        return chunk;
                    ...
                    case "reject":
                        if (startTransition) {
                            ...
                            returnToken = transition(stack, chunk, state, sanitizedOptions) || (0, $da9d03b67f2b5a2f$export$f883a24d5edde77c);
                        }
                        switch(chunk.name){
                            case "startObject":
                            case "startArray":
                        ...
                        if (state === "accept") returnToken = (0, $da9d03b67f2b5a2f$export$586a8898e7177441)(returnToken, chunk);
                        if (!depth) {
                    ...
                    case "reject-value":
                        ...
                        if (state === "accept-value") returnToken = (0, $da9d03b67f2b5a2f$export$586a8898e7177441)(returnToken, chunk);
                        if (chunk.name === endToken) {
                            // @ts-ignore
                            optionalToken = $42dd20cbfadceb69$var$optionalTokens[endToken] || "";
                            endToken = "";
                            if (!optionalToken) {
                ...
                $42dd20cbfadceb69$var$checkableTokens[chunk.name] !== 1 ? nonCheckableAction : filter(stack, chunk) ? specialAction : defaultAction;
                // @ts-ignore
                endToken = $42dd20cbfadceb69$var$stopTokens[chunk.name] || "";
                switch(action){
                    case "process-key":
                    ...
                    case "accept-token":
                        // @ts-ignore
                        if (endToken && $42dd20cbfadceb69$var$optionalTokens[endToken]) {
                            state = "accept-value";
                            startTransition = !!transition;
                            continue recheck;
                        }
                        if (transition) returnToken = transition(stack, chunk, action, sanitizedOptions);
                        returnToken = (0, $da9d03b67f2b5a2f$export$586a8898e7177441)(returnToken, chunk);
                        break;
                    case "accept":
                        if (endToken) {
                            // @ts-ignore
                            state = $42dd20cbfadceb69$var$optionalTokens[endToken] ? "accept-value" : "accept";
                            startTransition = !!transition;
                            continue recheck;
                        }
                        if (transition) returnToken = transition(stack, chunk, action, sanitizedOptions);
                    ...
                    case "reject":
                        if (endToken) {
                            // @ts-ignore
                            state = $42dd20cbfadceb69$var$optionalTokens[endToken] ? "reject-value" : "reject";
                            startTransition = !!transition;
                            continue recheck;
                        }
                        if (transition) returnToken = transition(stack, chunk, action, sanitizedOptions);
...
const $42dd20cbfadceb69$export$6f5a5bbde77b52cd = (options)=>$42dd20cbfadceb69$var$withParser($42dd20cbfadceb69$var$filterBase(), Object.assign({
        packKeys: true
    }, options));
class $42dd20cbfadceb69$var$Counter {
...
class $42dd20cbfadceb69$var$Assembler extends (0, $hgUW1$nodeevents) {
    static connectTo(stream, options) {
        return new $42dd20cbfadceb69$var$Assembler(options).connectTo(stream);
    }
    constructor(options){
        super();
        this.stack = [];
...
const $42dd20cbfadceb69$var$streamBase = ({ push: push, first: first, level: level })=>(options = {})=>{
        const { objectFilter: objectFilter, includeUndecided: includeUndecided } = options;
        let asm = new $42dd20cbfadceb69$var$Assembler(options), state = first ? "first" : "check", savedAsm = null;
                ...
                case "check":
                    if (asm[chunk.name]) {
                        ...
                        if (result) {
                            ...
                            state = "reject";
                            savedAsm = asm;
                            asm = new $42dd20cbfadceb69$var$Counter(savedAsm.depth);
...
const $42dd20cbfadceb69$export$d3281d37ba37c73c = (options)=>{
    let key = 0;
    return $42dd20cbfadceb69$var$streamBase({
        level: 1,
        first (chunk) {
...
async function* $ba5a1846053848df$var$streamJsonFile(filePath, pageSize, abortSignal, dataPath, filterFn, transformFn) {
    let page = [];
    const pipeline = (0, $da9d03b67f2b5a2f$export$2e2bcd8739ae039)([
        (0, $hgUW1$createReadStream)(filePath),
        dataPath ? (0, $42dd20cbfadceb69$export$6f5a5bbde77b52cd)({
            filter: dataPath
        }) : (0, $42dd20cbfadceb69$export$8f49e4af10703ce3)(),
        (0, $42dd20cbfadceb69$export$d3281d37ba37c73c)(),
...
function $ba5a1846053848df$export$48c74caed1925dc8(url, options) {
    ...
    const previousUrl = (0, $hgUW1$useRef)(null);
    const previousDestination = (0, $hgUW1$useRef)(null);
    const useCachedPromiseOptions = {
        initialData: initialData,
        execute: execute,
        keepPreviousData: keepPreviousData,
    ...
    return (0, $a7f3824c7be647eb$export$b15740c74e256244)((url, pageSize, fetchOptions, dataPath, filter, transform)=>async ({ page: page })=>{
            const fileName = (0, $e2e1ea6dd3b7d2e1$export$d6af199866bfb566)(url) + ".json";
...
class $da578bce0e88fb2a$export$cb7dc23b705f5c86 extends Error {
    constructor(message){
        super(message);
    ...
    try {
        ...
        if (error.errcode === 5 || error.errcode === 14 || error.message.match("(5)") || error.message.match("(14)")) {
            ...
            if (!workaroundCopiedDb) {
                const tempFolder = (0, $hgUW1$nodepath).join((0, $hgUW1$nodeos).tmpdir(), "useSQL", (0, $e2e1ea6dd3b7d2e1$export$d6af199866bfb566)(databasePath));
...
async function $da578bce0e88fb2a$var$sqliteFallback(databasePath, query, options) {
    const abortSignal = options?.signal;
    let spawned = (0, $hgUW1$nodechild_process).spawn("sqlite3", [
        "--json",
        "--readonly",
        databasePath,
        query
    ...
    if (stderrResult.match("(5)") || stderrResult.match("(14)")) {
        ...
        spawned = (0, $hgUW1$nodechild_process).spawn("sqlite3", [
            "--json",
            "--readonly",
            "--vfs",
            "unix-none",
...
function $e88ea8aee5e4e2a5$export$d74ef0af94fb1db6(databasePath, query, options) {
    ...
    const [permissionView, setPermissionView] = (0, $hgUW1$useState)(null);
    ...
    const handleError = (0, $hgUW1$useCallback)((_error)=>{
        ...
        if ((0, $da578bce0e88fb2a$export$e11674744930cd15)(error)) setPermissionView(/*#__PURE__*/ (0, $hgUW1$jsx)($e88ea8aee5e4e2a5$var$PermissionErrorScreen, {
    ...
    const fn = (0, $hgUW1$useMemo)(()=>{
        ...
        return async (databasePath, query)=>{
            ...
            return (0, $da578bce0e88fb2a$export$4cff4f142f384da7)(databasePath, query, {
                signal: abortSignal
            });
        };
    }, [
...
const $7d691a802b89543d$var$isX = !!process.env.RAYCASTX;
function $7d691a802b89543d$export$378f247c814d3cc9(name, options) {
    ...
    const svgInitials = initials ? `<text x="50" y="${$7d691a802b89543d$var$isX ? 50 : 80}" font-size="${radius - 1}" font-family="Inter, sans-serif" text-anchor="middle" ${$7d691a802b89543d$var$isX ? 'dominant-baseline="central" ' : ""}fill="white">${initials.toUpperCase()}</text>` : "";
...
function $d64c8f690cf3b07a$export$30c2a0095db95d06(url, options) {
    try {
        ...
        const urlObj = typeof url === "string" ? new (0, $hgUW1$URL)(sanitize(url)) : url;
        const hostname = urlObj.hostname;
        const faviconProvider = process.env.FAVICON_PROVIDER ?? "raycast";
        switch(faviconProvider){
            case "none":
                return {
                    source: options?.fallback ?? (0, $hgUW1$Icon).Link,
                    mask: options?.mask
                };
            case "apple":
...
const $6f4a1da9998d2612$export$f9b82956c86fe8e0 = {
...
class $a613cd7627dc664f$export$905bf243392675e9 {
   ...
   */ static asana(options) {
        return new $a613cd7627dc664f$export$905bf243392675e9({
            ...
            clientId: options.clientId ?? (0, $6f4a1da9998d2612$export$f9b82956c86fe8e0).asana,
   ...
   */ static github(options) {
        return new $a613cd7627dc664f$export$905bf243392675e9({
            ...
            clientId: options.clientId ?? (0, $6f4a1da9998d2612$export$f9b82956c86fe8e0).github,
   ...
   */ static linear(options) {
        return new $a613cd7627dc664f$export$905bf243392675e9({
            ...
            clientId: options.clientId ?? (0, $6f4a1da9998d2612$export$f9b82956c86fe8e0).linear,
   ...
   */ static slack(options) {
        return new $a613cd7627dc664f$export$905bf243392675e9({
            ...
            clientId: options.clientId ?? (0, $6f4a1da9998d2612$export$f9b82956c86fe8e0).slack,
    ...
    return (Component)=>{
        const WrappedComponent = (props)=>{
            if (options.personalAccessToken) {
                ...
                if (!$610e71f8af383779$var$authorize) $610e71f8af383779$var$authorize = options.authorize();
                $610e71f8af383779$var$token = (0, $hgUW1$react).use($610e71f8af383779$var$authorize);
                $610e71f8af383779$var$type = "oauth";
            }
            let idToken;
            if (options.client) {
                if (!$610e71f8af383779$var$getIdToken) $610e71f8af383779$var$getIdToken = options.client?.getTokens().then((tokens)=>tokens?.idToken);
                idToken = (0, $hgUW1$react).use($610e71f8af383779$var$getIdToken);
            }
            if (options.onAuthorize) {
                if (!$610e71f8af383779$var$onAuthorize) $610e71f8af383779$var$onAuthorize = Promise.resolve(options.onAuthorize({
                    token: $610e71f8af383779$var$token,
                    type: $610e71f8af383779$var$type,
                    idToken: idToken
                }));
                (0, $hgUW1$react).use($610e71f8af383779$var$onAuthorize);
            }
...
var $7b2399a584bd1625$export$a7e8ed272ae8db08 = /*#__PURE__*/ function(DeeplinkType) {
    /** A script command */ DeeplinkType["ScriptCommand"] = "script-command";
    /** An extension command */ DeeplinkType["Extension"] = "extension";
    return DeeplinkType;
}({});
function $7b2399a584bd1625$var$getProtocol() {
    return (0, $hgUW1$environment).raycastVersion.includes("alpha") ? process.env.RAYCASTX ? "raycast-x-internal://" : "raycastinternal://" : "raycast://";
}
function $7b2399a584bd1625$var$getOwnerOrAuthorName() {
    const packageJSON = JSON.parse((0, $hgUW1$nodefs).readFileSync((0, $hgUW1$nodepath).join((0, $hgUW1$environment).assetsPath, "..", "package.json"), "utf8"));
    return packageJSON.owner || packageJSON.author;
}
function $7b2399a584bd1625$export$f537f4c2068da401(options) {
    let url = `${$7b2399a584bd1625$var$getProtocol()}script-commands/${options.command}`;
...
function $7b2399a584bd1625$export$ddb13afcb01cd60d(options) {
    let ownerOrAuthorName = $7b2399a584bd1625$var$getOwnerOrAuthorName();
    let extensionName = (0, $hgUW1$environment).extensionName;
    if ("ownerOrAuthorName" in options && "extensionName" in options) {
        ownerOrAuthorName = options.ownerOrAuthorName;
        extensionName = options.extensionName;
    }
    let url = `${$7b2399a584bd1625$var$getProtocol()}extensions/${ownerOrAuthorName}/${extensionName}/${options.command}`;
    let params = "";
...
function $7b2399a584bd1625$export$c4dc2df9fd7350e0(options) {
    if (options.type === "script-command") return $7b2399a584bd1625$export$f537f4c2068da401(options);
    else return $7b2399a584bd1625$export$ddb13afcb01cd60d(options);
}



function $a7c2dd1abcf08364$export$71c177e77c592df2(databasePath, query) {
    return (0, $da578bce0e88fb2a$export$4cff4f142f384da7)(databasePath, query);
}
...
async function $0c3b8057691eb3cf$export$fc36b0024b60e761(script, options) {
    ...
    const spawned = (0, $hgUW1$nodechild_process).spawn("powershell.exe", outputArguments, {
        ...execOptions
    });
    const spawnedPromise = (0, $c86e3701e284ece4$export$6e3a9b5342d42997)(spawned, {
        timeout: timeout ?? 10000
...
function $155078c0ae8ac51d$export$33b32b3abf8170f0(fn, options) {
    const cache = new (0, $hgUW1$Cache)({
        namespace: (0, $e2e1ea6dd3b7d2e1$export$d6af199866bfb566)(fn)
    });
    const wrappedFn = async (...args)=>{
        const key = (0, $e2e1ea6dd3b7d2e1$export$d6af199866bfb566)(args || []) + options?.internal_cacheKeySuffix;
        const cached = cache.get(key);
        if (cached) {
            const { data: data, timestamp: timestamp } = JSON.parse(cached, (0, $e2e1ea6dd3b7d2e1$export$63698c10df99509c));
        ...
        cache.set(key, JSON.stringify({
            data: result,
            timestamp: Date.now()
        }, (0, $e2e1ea6dd3b7d2e1$export$b644b65666fe0c18)));
        return result;
    };
